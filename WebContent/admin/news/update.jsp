...
<html class="x-admin-sm">
    ...
    <body>
                ...
                <form class="layui-form" name="myform" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="title" name="title" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${news.title}"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="author" class="layui-form-label">
                            <span class="x-red">*</span>发布人</label>
                        <div class="layui-input-inline">
                            <input type="text" id="author" name="author" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${news.author}"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="clicks" class="layui-form-label">
                            <span class="x-red">*</span>点击率</label>
                        <div class="layui-input-inline">
                            <input type="text" id="clicks" name="clicks" required=""  autocomplete="off" class="layui-input" value="${news.clicks}"></div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select id="typeId" name="typeId" class="valid">
                               <c:forEach var="newsType" items="${ newsTypeList}">
                               		<c:if test="${newsType.typeId==news.typeId}">
                   ...
                   <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="postTime" name="postTime" required=""  autocomplete="off" class="layui-input" value="<fmt:formatDate value='${news.postTime}' pattern='yyyy-MM-dd HH:mm:ss'/>"></div>
                    </div>
        <div class="layui-form-item layui-form-text">
            <label for="description" class="layui-form-label">内容</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="description" name="description" class="layui-textarea" lay-verify="description">${news.description}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <script>layui.use(['form', 'layer','laydate','layedit','jquery'],
            function() {
                $ = layui.jquery;
                var form = layui.form,
                layer = layui.layer,
              ...
              //执行一个laydate实例
               ...
               /*  //自定义验证规则
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type:"POST",
                    	url:"${pageContext.request.contextPath}/AdminNewsServlet?flag=update",
                    	data:data.field,
