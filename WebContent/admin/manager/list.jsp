			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn" onclick="showList()">
					...
					<div class="layui-card-body layui-table-body layui-table-main">
						<table class="layui-table layui-form">
							<thead>
								<tr>
									<th width="5%"><input type="checkbox"
										lay-filter="checkall" name="" lay-skin="primary"></th>
									<th>ID</th>
									<th>用户名</th>
									<th>密码</th>
									<th>操作</th>
							...
							<tbody>
									...
									<tr>
										<td><input type="checkbox" name="id" value="${user.uid}"
											lay-skin="primary"></td>
										<td>${user.uid}</td>
										<td>${user.uname}</td>
										<td>${user.upass}</td>
										<td class="td-manage"><a title="编辑"
											onclick="xadmin.open('编辑','${pageContext.request.contextPath}/AdminManagerServlet?flag=toUpdate&uid=${user.uid}',700,500)"
											href="javascript:;"> <i class="layui-icon">&#xe642;</i>			
										</a>
										<a title="删除" onclick="del()" href="javascript:;">
					...
					<div class="layui-card-body ">
						<div class="page">
							<div>
								<a class="prev" href="AdminManagerServlet?flag=list">&lt;&lt;</a>

								1 <a class="next" href="AdminManagerServlet?flag=list">&gt;&gt;</a>
							</div>
						</div>
					</div>
				</div>
				...
				.confirm(
						...
						function(index) {
							$
									.ajax({
										type : "POST",
										url : "${pageContext.request.contextPath}/AdminManagerServlet?flag=delete&id="
												+ id,
				...
				.confirm(
						...
						function(index) {
							...
							$
									.ajax({
										type : "POST",
										url : "${pageContext.request.contextPath}/AdminManagerServlet?flag=Manydelete&Ids="
												+ ids.toString(),
										success : function(result) {
											console.log(result + "====");
											if (result == "ok") {
