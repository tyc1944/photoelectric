                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="uname" name="uname" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${user.uname}"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="upass" class="layui-form-label">
                            <span class="x-red">*</span>密码</label>
                        <div class="layui-input-inline">
                            <input type="text" id="upass" name="upass" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${user.upass}"></div>
                    </div>                                                
        <div class="layui-form-item">
        ...
        <script>layui.use(['form', 'layer'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type:"POST",
                    	url:"${pageContext.request.contextPath}/AdminManagerServlet?flag=update",
                    	data:data.field,
