    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                ...
                <input type="hidden" id="typeId" name="typeId" value="${newstype.typeId}">
                    <div class="layui-form-item">
                        <label for="typename" class="layui-form-label">
                            <span class="x-red">*</span>新闻类型名称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="typename" name="typename" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${newstype.typeName}"></div>
                    </div>
            ...
            function() {
               ...
               form.on('submit(modify)',
                function(data) {
                    ...
                    $.ajax({
                    	type:"POST",
                    	url:"${pageContext.request.contextPath}/AdminNewsTypeServlet?flag=update",
                    	data:data.field,
