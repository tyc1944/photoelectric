	...
	<div class="layui-fluid">
		<div class="layui-row">
			<form class="layui-form">
				<input type="hidden" name="typeId" value="${companymap.typeId}">
				<a
					onclick="xadmin.open('修改密码','http://api.map.baidu.com/lbsapi/creatmap/',600,500)"
					class="layui-btn">获得地图代码</a> <br>
				<br>
				<div class="layui-form-item layui-form-text">
					<label for="typeName" class="layui-form-label">请输入复制的地图代码</label>
					<div class="layui-input-block">
						<textarea placeholder="请输入复制的地图代码" id="typeName" name="typeName"
							class="layui-textarea" lay-verify="typeName"></textarea>
					</div>
				</div>
	...
	<script>layui.use(['form', 'layer','layedit','jquery'],
            ...
            form.verify({
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type:"POST",
                    	url:"${pageContext.request.contextPath}/AdminCompanyMapServlet?flag=update",
                    	data:data.field,
