<%@page import="com.electric.entity.About"%>
...
<div class="frame_l">
	...
	<!--classp begin-->
	<div class="box1">
	<div class="box1_t"><h3>关于我们</h3></div>
	<div class="box1_m">
...
<ul class="sidebar">
	...
	%>
     ...
     <li><a href="aboutServlet_findAll?aboutId=<%=about.getProId()%>"><%=about.getTitle()%></a></li>
...
<div class="frame_r">
	...
	<!--关于我们  begin-->
	<div class="box4">
	<div class="box4_t"><span><a href=IndexServlet>首页</a>&nbsp;&raquo;&nbsp;关于我们</span></div>
	<%
