        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form">
                	<input type="hidden" name="proId" value="${about.proId}">
                    <div class="layui-form-item">
                        <label for="title" class="layui-form-label">
                            <span class="x-red">*</span>标题</label>
                        <div class="layui-input-inline">
                            <input type="text" id="title" name="title" required="" lay-verify="required" autocomplete="off" class="layui-input" value="${about.title}"></div>
                    </div>
   
        <div class="layui-form-item layui-form-text">
            <label for="content" class="layui-form-label">内容</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="content" name="content" class="layui-textarea" lay-verify="content">${about.content}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        form.verify({
            content: function(value) {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type:"POST",
                    	url:"${pageContext.request.contextPath}/AdminAboutServlet?flag=update",
                    	data:data.field,
